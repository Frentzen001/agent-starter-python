...
This file is the LiveKit-specific agent guide for `agent-starter-python`.

For cross-repo MoreTea architecture, canonical docs, and workspace-level guidance, read [AGENTS.md](/home/frentzen/FYP/AGENTS.md) first.
